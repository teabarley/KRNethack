...
NEARDATA struct permonst mons[] = {
     ...
     * ants
     */
    MON("거대 개미", S_ANT, LVL(2, 18, 3, 0, 0), (G_GENO | G_SGROUP | 3),
        ...
        4, CLR_BROWN),
    MON("살인벌", S_ANT, LVL(1, 18, -1, 0, 0), (G_GENO | G_LGROUP | 2),
        ...
        5, CLR_YELLOW),
    MON("병정개미", S_ANT, LVL(3, 18, 3, 0, 0), (G_GENO | G_SGROUP | 2),
    ...
    MON("불개미", S_ANT, LVL(3, 18, 3, 10, 0), (G_GENO | G_SGROUP | 1),
    ...
    MON("왕딱정벌레", S_ANT, LVL(5, 6, 4, 0, 0), (G_GENO | 3),
        ...
        6, CLR_BLACK),
    MON("여왕벌", S_ANT, LVL(9, 24, -4, 0, 0), (G_GENO | G_NOGEN),
     ...
     * blobs
     */
    MON("산성 방울", S_BLOB, LVL(1, 3, 8, 0, 0), (G_GENO | 2),
    ...
    MON("진동 방울", S_BLOB, LVL(5, 1, 8, 0, 0), (G_GENO | 2),
    ...
    MON("젤라틴 큐브", S_BLOB, LVL(6, 6, 8, 0, 0), (G_GENO | 2),
     ...
     * cockatrice
     */
    MON("치카트리스", S_COCKATRICE, LVL(4, 4, 8, 30, 0),
        (G_GENO | G_SGROUP | 1),
    ...
    MON("코카트리스", S_COCKATRICE, LVL(5, 6, 6, 30, 0), (G_GENO | 5),
    ...
    MON("파이로리스크", S_COCKATRICE, LVL(6, 6, 6, 30, 0), (G_GENO | 1),
     ...
     * dogs & other canines
     */
    MON("자칼", S_DOG, LVL(0, 12, 7, 0, 0), (G_GENO | G_SGROUP | 3),
        ...
        1, CLR_BROWN),
    MON("여우", S_DOG, LVL(0, 15, 7, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        1, CLR_RED),
    MON("코요테", S_DOG, LVL(1, 12, 7, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        2, CLR_BROWN),
    MON("자칼인간", S_DOG, LVL(2, 12, 7, 10, -7), (G_NOGEN | G_NOCORPSE),
    ...
    MON("작은 개", S_DOG, LVL(2, 18, 6, 0, 0), (G_GENO | 1),
        ...
        3, HI_DOMESTIC),
    MON("딩고", S_DOG, LVL(4, 16, 5, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(400, 200, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        5, CLR_YELLOW),
    MON("개", S_DOG, LVL(4, 16, 5, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(400, 200, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_DOMESTIC, M3_INFRAVISIBLE,
        5, HI_DOMESTIC),
    MON("커다란 개", S_DOG, LVL(6, 15, 4, 0, 0), (G_GENO | 1),
    ...
    MON("늑대", S_DOG, LVL(5, 12, 4, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 250, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        6, CLR_BROWN),
    MON("늑대인간", S_DOG, LVL(5, 12, 4, 20, -7), (G_NOGEN | G_NOCORPSE),
    ...
    MON("새끼 겨울늑대", S_DOG, LVL(5, 12, 4, 0, -5),
    ...
    MON("와르그", S_DOG, LVL(7, 12, 4, 0, -5), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(850, 350, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        8, CLR_BROWN),
    MON("겨울늑대", S_DOG, LVL(7, 12, 4, 20, 0), (G_NOHELL | G_GENO | 1),
        ...
        9, CLR_CYAN),
    MON("새끼 지옥견", S_DOG, LVL(7, 12, 4, 20, -5),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        9, CLR_RED),
    MON("지옥견", S_DOG, LVL(12, 14, 2, 20, 0), (G_HELL | G_GENO | 1),
...
#ifdef CHARON
    MON("케르베로스", S_DOG, LVL(12, 10, 2, 20, -7),
     ...
     * eyes
     */
    MON("가스 포자", S_EYE, LVL(1, 3, 10, 0, 0), (G_NOCORPSE | G_GENO | 1),
    ...
    MON("떠다니는 눈알", S_EYE, LVL(2, 1, 9, 10, 0), (G_GENO | 5),
    ...
    MON("동결 구체", S_EYE, LVL(6, 13, 4, 0, 0),
    ...
    MON("화염 구체", S_EYE, LVL(6, 13, 4, 0, 0),
    ...
    MON("전격 구체", S_EYE, LVL(6, 13, 4, 0, 0),
    ...
    MON("재규어", S_FELINE, LVL(4, 15, 6, 0, 0), (G_GENO | 2),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        6, CLR_BROWN),
    MON("스라소니", S_FELINE, LVL(5, 15, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
          ATTK(AT_BITE, AD_PHYS, 1, 10), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROWL, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        7, CLR_CYAN),
    MON("표범", S_FELINE, LVL(5, 15, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
          ATTK(AT_BITE, AD_PHYS, 1, 10), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROWL, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        7, CLR_BLACK),
    MON("커다란 고양이", S_FELINE, LVL(6, 15, 4, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(250, 250, MS_MEW, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_STRONG | M2_DOMESTIC,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("호랑이", S_FELINE, LVL(6, 12, 6, 0, 0), (G_GENO | 2),
     ...
     */
    MON("그렘린", S_GREMLIN, LVL(5, 12, 2, 25, -9), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
        ...
        8, CLR_GREEN),
    MON("가고일", S_GREMLIN, LVL(6, 10, -4, 0, -9), (G_GENO | 2),
        ...
        0, 8, CLR_BROWN),
    MON("날개달린 가고일", S_GREMLIN, LVL(9, 15, -2, 0, -12), (G_GENO | 1),
     ...
     * humanoids
     */
    MON("호빗", S_HUMANOID, LVL(1, 9, 10, 0, 6), (G_GENO | 2),
    ...
    MON("드워프", S_HUMANOID, LVL(2, 6, 10, 10, 4), (G_GENO | 3),
    ...
    MON("버그베어", S_HUMANOID, LVL(3, 9, 5, 0, -6), (G_GENO | 1),
    ...
    MON("드워프 군주", S_HUMANOID, LVL(4, 6, 10, 10, 5), (G_GENO | 2),
    ...
    MON("드워프 왕", S_HUMANOID, LVL(6, 6, 10, 20, 6), (G_GENO | 1),
    ...
    MON("정신 강탈자", S_HUMANOID, LVL(9, 12, 5, 90, -8), (G_GENO | 1),
    ...
    MON("우두머리 정신 강탈자", S_HUMANOID, LVL(13, 12, 0, 90, -8),
        (G_GENO | 1),
    ...
    MON("호문클루스", S_IMP, LVL(2, 12, 6, 10, -7), (G_GENO | 2),
    ...
    MON("콰짓", S_IMP, LVL(3, 15, 2, 20, -7), (G_GENO | 2),
    ...
    MON("텐구", S_IMP, LVL(6, 13, 5, 30, 7), (G_GENO | 3),
     ...
     * jellies
     */
    MON("파란 젤리", S_JELLY, LVL(4, 0, 8, 10, 0), (G_GENO | 2),
    ...
    MON("점박이 젤리", S_JELLY, LVL(5, 0, 8, 10, 0), (G_GENO | 1),
    ...
    MON("황토색 젤리", S_JELLY, LVL(6, 3, 8, 20, 0), (G_GENO | 2),
     ...
     * kobolds
     */
    MON("코볼트", S_KOBOLD, LVL(0, 6, 10, 0, -2), (G_GENO | 1),
    ...
    MON("커다란 코볼트", S_KOBOLD, LVL(1, 6, 10, 0, -3), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(450, 150, MS_ORC, MZ_SMALL), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_OMNIVORE, M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 2, CLR_RED),
    MON("코볼트 군주", S_KOBOLD, LVL(2, 6, 10, 0, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("코볼트 주술사", S_KOBOLD, LVL(2, 6, 6, 10, -4), (G_GENO | 1),
     ...
     * leprechauns
     */
    MON("레프리콘", S_LEPRECHAUN, LVL(5, 15, 8, 20, 0), (G_GENO | 4),
     ...
     * mimics
     */
    MON("작은 미믹", S_MIMIC, LVL(7, 3, 7, 0, 0), (G_GENO | 2),
    ...
    MON("커다란 미믹", S_MIMIC, LVL(8, 3, 7, 10, 0), (G_GENO | 1),
    ...
    MON("거대한 미믹", S_MIMIC, LVL(9, 3, 7, 20, 0), (G_GENO | 1),
     ...
     * nymphs
     */
    MON("나무 님프", S_NYMPH, LVL(3, 12, 9, 20, 0), (G_GENO | 2),
     ...
     */
    MON("오크", S_ORC, LVL(1, 9, 10, 0, -3), (G_GENO | G_NOGEN | G_LGROUP),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("오크 대장", S_ORC, LVL(5, 5, 10, 0, -5), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
