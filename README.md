...
> not affiliated with the NetHack DevTeam or the JNetHack team.)
...
### [ ] Phase 3: win/ & sys/ (Windows UI 및 시스템 번역) - _지속 검수 중_
...
[버그 신고 (구글 폼)](https://forms.gle/n1VrMLBQuiirNF2Q7)

## 라이선스 (License)
NetHack General Public License (NGPL) 을 따릅니다.  
자세한 사항은 소스 코드 내의 dat/license 파일을 참고해 주십시오.  
[영어 원문 링크](https://www.nethack.org/common/license.html)  
[한글 번역 링크](https://www.olis.or.kr/ossdownfile/license/1041_KO.pdf)
